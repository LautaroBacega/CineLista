...
export default function SharedList() {
  ...
  const shareList = async () => {
    const shareData = {
      ...
      text: `¡Mirá esta increíble lista de películas: ${list.name}! 🎬`,
  ...
  return (
    <>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border border-cinema-neutral-200 p-8 lg:p-12 mb-8">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              ...
              <div className="flex-shrink-0">
                <button onClick={shareList} className="btn-secondary flex items-center gap-2">
                  <Share2 size={18} />
                  Compartir Lista
                </button>
              </div>
      ...
      <CopySuccessModal
        ...
        title="¡Enlace de Lista Copiado! 📋"
        message="El enlace de la lista compartida se ha copiado al portapapeles. Ahora podés compartirlo con quien quieras."
        type="share"
      />
    </>
  )
